                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('ProductController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name_secondary" class="form-control col-md-7 col-xs-12" name="title_secondary" placeholder="e.g Attractive Jeans élégant pour les femmes" type="text">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="model" class="form-control col-md-7 col-xs-12" name="model" placeholder="e.g Jeans" type="text">
                                </div>
                            </div>
