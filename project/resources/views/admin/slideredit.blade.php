                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('SliderController@update',['id'=>$slider->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slug">Link</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="link" class="form-control col-md-7 col-xs-12" name="link" value="{{$slider->link}}" placeholder="e.g https://linktoyourwebsite.com" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
